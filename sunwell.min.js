...
c.restore();clearTimeout(l);r("Rendertime: "+(Date.now()-m)+"ms");e();f.target.src=b.toDataURL()}function T(b){E.push([b,this]);A||J()}function J(){O&&(U(),window.requestAnimationFrame(J))}function U(){if(!(12<A)){var b,c,d;if(E.length){var a=E.shift();A++;b=a[0];c=b.width;d=a[1];var f=C(c,Math.round(1.4397905759*c),!0),e=f.getContext("2d"),g=c/764,a=["silence-x"];b._assetsLoaded===c?N(f,e,b,g,d,function(){A--;r("Card rendered: "+b.title);t.push(f)}):(r("Preparing assets for: "+b.title),b.sunwell=
b.sunwell||{},b.sunwell.cardBack=b.type.substr(0,1).toLowerCase()+b.playerClass.substr(0,1)+b.playerClass.substr(1).toLowerCase(),a.push(b.sunwell.cardBack),a.push("gem"),"MINION"===b.type&&(a.push("attack","health","title"),"LEGENDARY"===b.rarity&&a.push("dragon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),"SPELL"===b.type&&(a.push("attack","health","title-spell"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===
b.set||(b.sunwell.rarity="spell-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),"WEAPON"===b.type&&(a.push("swords","shield","title-weapon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="weapon-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),-1==="BRM GVG LOE NAX TGT OG".split(" ").indexOf(b.set)?b.sunwell.bgLogo="bg-cl":b.sunwell.bgLogo="bg-"+b.set.toLowerCase(),"SPELL"===b.type&&(b.sunwell.bgLogo="spell-"+b.sunwell.bgLogo),"WEAPON"===b.type&&(b.sunwell.bgLogo=
