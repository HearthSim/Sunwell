 ...
 */
(function(){function z(){return A.length?A.pop():document.createElement("canvas")}function N(){if(H)return H;var a=z(),e=a.getContext("2d");a.width=a.height=512;e.save();e.fillStyle="grey";e.fillRect(0,0,512,512);e.fill();e.fillStyle="red";e.textAlign="center";e.textBaseline="middle";e.font="50px Belwe, serif";e.fillText("missing artwork",256,256);e.restore();return H=a.toDataURL()}function O(a,e,k,c,g){var d=c/2*.5522848,b=g/2*.5522848,f=e+c,q=k+g;c=e+c/2;g=k+g/2;a.beginPath();a.moveTo(e,g);a.bezierCurveTo(e,
g-b,c-d,k,c,k);a.bezierCurveTo(c+d,k,f,g-b,f,g);a.bezierCurveTo(f,g+b,c+d,q,c,q);a.bezierCurveTo(c-d,q,e,g+b,e,g);a.stroke()}function R(a){return new Promise(function(e){for(var w=0,c=1,g={},d,b,f,q,I=0;I<a.length;I++)d=a[I],f=b=!1,"h:"===d.substr(0,2)&&(b=!0,f=!!k.settings.smallTextureFolder,d=d.substr(2)),"t:"===d.substr(0,2)&&(b=!0,d=d.substr(2),void 0!==h[d]&&256===h[d].width&&(h[d]=void 0)),"u:"===d.substr(0,2)&&(q=!0,d=d.substr(2)),void 0===h[d]?(h[d]=new Image,h[d].crossOrigin="Anonymous",
h[d].loaded=!1,c++,function(a){h[a].addEventListener("load",function(){w++;h[a].loaded=!0;g[a]=h[a];w>=c&&e(g)});h[a].addEventListener("error",function(){w++;h[a].isTexture&&(console.log("Replacing "+h[a].src+" with substitute."),h[a].src=N(),h[a].loaded=!0,g[a]=h[a],w>=c&&e(g))})}(d),q?h[d].src=d:b?(h[d].isTexture=!0,h[d].src=f?k.settings.smallTextureFolder+d+".jpg":k.settings.textureFolder+d+".jpg"):h[d].src=k.settings.assetFolder+d+".png"):(c++,h[d].loaded?(w++,g[d]=h[d]):function(a){h[a].addEventListener("load",
function(){w++;g[a]=h[a];w>=c&&e(g)})}(d));c--;0<w&&w>=c&&e(g)})}function J(a){var e=a.canvas.width,k=a.canvas.height;a=a.getImageData(0,0,e,k).data;var c,g,d=999,b=999,f=0,q=0,h=!1;for(g=k-1;-1<g&&!h;g--)for(c=0;c<e;c++)if(0<a[4*g*e+4*c+3]){q=Math.max(q,g);h=!0;break}if(void 0===q)return null;c=e-1;a:for(;-1<c;c--)for(g=0;g<k;g++)if(0<a[4*g*e+4*c+3]){f=Math.max(f,c);break a}c=0;a:for(;c<f;c++)for(g=0;g<k;g++)if(0<a[4*g*e+4*c+3]){d=Math.min(c,d);break a}g=0;a:for(;g<q;g++)for(c=0;c<e;c++)if(0<a[4*
g*e+4*c+3]){b=Math.min(b,g);break a}return{x:d,y:b,maxX:f,maxY:q,w:f-d,h:q-b}}function F(a,e,k,c,g,d,b,f){var q=z(),h=q.getContext("2d");void 0===b&&(b=g);q.width=256;q.height=256;g=g.toString();g=g.split("");var m=10;h.font=d+"px Belwe";h.lineCap="round";h.lineJoin="round";h.textBaseline="hanging";h.textAlign="left";d="white";f?(g>b&&(d="#f00"),g<b&&(d="#0f0")):(g<b&&(d="#f00"),g>b&&(d="#0f0"));for(b=0;b<g.length;b++)h.lineWidth=13,h.strokeStyle="black",h.fillStyle="black",h.fillText(g[b],m,10),
h.strokeText(g[b],m,10),h.fillStyle=d,h.strokeStyle=d,h.lineWidth=2.5,h.fillText(g[b],m,10),m+=h.measureText(g[b]).width;g=J(h);a.drawImage(q,g.x,g.y,g.w,g.h,(e-g.w/2)*c,(k-g.h/2)*c,g.w*c,g.h*c);A.push(q)}function P(a,e,h,c,g,d){k.settings.debug&&(a.save(),a.strokeStyle="red",a.beginPath(),a.moveTo(d/2-c/2,g),a.lineTo(d/2+c/2,g),a.stroke(),a.restore());d=d/2-c/2;0>d&&(d=0);a.drawImage(e,0,0,Math.min(c,e.width),e.height,d,g,Math.min(c,e.width),e.height);c=5;g+=e.height;h.clearRect(0,0,e.width,e.height);
return[c,g]}function K(a,e){return{x:Math.pow(1-e,3)*a[0].x+3*Math.pow(1-e,2)*e*a[1].x+3*(1-e)*Math.pow(e,2)*a[2].x+Math.pow(e,3)*a[3].x,y:Math.pow(1-e,3)*a[0].y+3*Math.pow(1-e,2)*e*a[1].y+3*(1-e)*Math.pow(e,2)*a[2].y+Math.pow(e,3)*a[3].y,r:Math.atan2(3*Math.pow(1-e,2)*(a[1].y-a[0].y)+6*(1-e)*e*(a[2].y-a[1].y)+3*Math.pow(e,2)*(a[3].y-a[2].y),3*Math.pow(1-e,2)*(a[1].x-a[0].x)+6*(1-e)*e*(a[2].x-a[1].x)+3*Math.pow(e,2)*(a[3].x-a[2].x))}}function L(a,e,k){y.push([a,e,k]);G||M()}function M(){Q&&(S(),window.requestAnimationFrame(M))}
...
D/8);n+=D}P(e,c,m,n,E,f.width);A.push(c);l=J(e);l.h=Math.ceil(l.h/c.height)*c.height;d.drawImage(f,l.x,l.y-2,l.w,l.h,(390-l.w/2)*b,(860-l.h/2)*b,l.w*b,(l.h+2)*b);A.push(f);k.settings.debug&&(d.save(),d.strokeStyle="green",d.beginPath(),d.rect((390-l.w/2)*b,(860-l.h/2)*b,l.w*b,(l.h+2)*b),d.stroke(),d.strokeStyle="red",d.beginPath(),d.rect((390-f.width/2)*b,(860-f.height/2)*b,f.width*b,(f.height+2)*b),d.stroke(),d.restore());F(d,116,170,b,a.cost||0,170,a._originalCost,!0);l=z();r=a.title;l.width=1024;
...
2;n*=1.25}n/=p;t-=n/2;n/=r.length;k.settings.debug&&(f.save(),f.strokeStyle="red",f.lineWidth=5,f.beginPath(),f.moveTo(c[0].x,c[0].y),f.bezierCurveTo(c[1].x,c[1].y,c[2].x,c[2].y,c[3].x,c[3].y),f.stroke(),f.restore());for(var v,m=p=0;m<r.length;m++){if(0===p)v=t+n*m,u=K(c,v),p=u.x;else for(v+=.01,u=K(c,v);u.x<p;)v+=.001,u=K(c,v);f.save();f.translate(u.x,u.y);f.scale(1.2,1);f.rotate(u.r);f.lineWidth=e/50*10;f.strokeStyle="black";f.fillStyle="black";f.fillText(r[m],0,0);f.strokeText(r[m],0,0);u=1.25*
...
f.textBaseline="hanging";f.textAlign="left";l=l.split("");r=10;for(c=0;c<l.length;c++)f.lineWidth=8,f.strokeStyle="black",f.fillStyle="black",f.fillText(l[c],r,10),f.strokeText(l[c],r,10),f.fillStyle="white",f.strokeStyle="white",f.lineWidth=1,f.fillText(l[c],r,10),r+=f.measureText(l[c]).width;l=J(f);d.drawImage(v,l.x,l.y,l.w,l.h,(394-l.w/2)*b,(1001-l.h/2)*b,l.w*b,l.h*b);A.push(v)}F(d,128,994,b,a.attack||0,150,a._originalAttack);F(d,668,994,b,a.health||0,150,a._originalHealth)}"WEAPON"===a.type&&
(F(d,128,994,b,a.attack||0,150,a._originalAttack),F(d,668,994,b,a.durability||0,150,a._originalDurability));d.restore();w&&w(g);G--;A.push(g)})}}}var k,h={},Q=!1,y=[],G=0,t={},A=[],T=["COMMON","RARE","EPIC","LEGENDARY"],H;window.sunwell=k=window.sunwell||{};k.settings=k.settings||{};k.settings.titleFont=k.settings.titleFont||"Belwe Bold";k.settings.bodyFont=k.settings.bodyFont||"ITC Franklin Condensed";k.settings.bodyFontSize=k.settings.bodyFontSize||60;k.settings.bodyFontOffset=k.settings.bodyFontOffset||
{x:0,y:0};k.settings.bodyLineHeight=k.settings.bodyLineHeight||50;k.settings.assetFolder=k.settings.assetFolder||"/assets/";k.settings.textureFolder=k.settings.textureFolder||"/artwork/";k.settings.smallTextureFolder=k.settings.smallTextureFolder||null;k.settings.autoInit=k.settings.autoInit||!0;k.settings.idAsTexture=k.settings.idAsTexture||!1;k.settings.debug=k.settings.debug||!1;k.init=function(){Q=!0;y.length&&M()};k.settings.autoInit||k.init();k.races={enUS:{MURLOC:"Murloc",MECHANICAL:"Mech",
BEAST:"Beast",DEMON:"Demon",PIRATE:"Pirate",DRAGON:"Dragon",TOTEM:"Totem"},deDE:{MURLOC:"Murloc",MECHANICAL:"Mech",BEAST:"Wildtier",DEMON:"D\u00e4mon",PIRATE:"Pirat",DRAGON:"Drache",TOTEM:"Totem"}};h.empty=new Image;h.empty.src=N();k.clearCache=function(){t={}};k.createCard=function(a,e,h){if(!a)throw Error("No card object given");h||(h=new Image);-1===T.indexOf(a.rarity)&&(a.rarity="FREE");void 0===a.title&&(a.title=a.name);void 0===a.gameId&&(a.gameId=a.id);void 0===a.textMarkdown&&(a.textMarkdown=
a.text.replace(/<\/*b>/g,"**"));k.settings.idAsTexture&&(a.texture=a.gameId);var c=e+"_"+a.language+"_"+a.gameId+"_"+a.cost+"_"+a.attack+"_"+a.health;a._originalCost=a.cost;a._originalHealth=a.health;a._originalAttack=a.attack;a._originalDurability=a.durability;if(t[c])h.src=t[c];else return L(a,e,function(a){h.src=t[c]=a.toDataURL()}),{target:h,redraw:function(){c=e+"_"+a.language+"_"+a.gameId+"_"+a.cost+"_"+a.attack+"_"+a.health+"_"+a.health;delete t[c];L(a,e,function(a){h.src=t[c]=a.toDataURL()})},
update:function(g){for(var d in g)a[d]=g[d];c=e+"_"+a.language+"_"+a.gameId+"_"+a.cost+"_"+a.attack+"_"+a.health+"_"+a.health;t[c]?h.src=t[c]:L(a,e,function(a){h.src=t[c]=a.toDataURL()})}}}})();