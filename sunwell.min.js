...
c.fillStyle="red";c.textAlign="center";c.textBaseline="middle";c.font="50px Belwe";c.fillText("missing artwork",256,256);c.restore();B=new Image;B.src=b.toDataURL();return B}function n(b){return m[b]||F(b)}function K(b){var c,d=305419896;c=""+b.gameId;c+=b.playerClass;c+=b.race;c+=b.rarity;c+=b.set;c+=b.silenced;c+=b.texture;c+=b.type;c+=b.width;for(b=0;b<c.length;b++)d+=c.charCodeAt(b)*(b+1);return d}function L(b,c,d,a,f){var e=a/2*.5522848,q=f/2*.5522848,h=c+a,g=d+f;a=c+a/2;f=d+f/2;b.beginPath();
b.moveTo(c,f);b.bezierCurveTo(c,f-q,a-e,d,a,d);b.bezierCurveTo(a+e,d,h,f-q,h,f);b.bezierCurveTo(h,f+q,a+e,g,a,g);b.bezierCurveTo(a-e,g,c,f+q,c,f);b.stroke()}function P(b){return new Promise(function(c){for(var d=0,a=1,f={},e,q,h,l,k=0;k<b.length;k++)e=b[k],h=q=!1,"h:"===e.substr(0,2)&&(q=!0,h=!!g.settings.smallTextureFolder,e=e.substr(2)),"t:"===e.substr(0,2)&&(q=!0,e=e.substr(2),void 0!==m[e]&&256===m[e].width&&(m[e]=void 0)),"u:"===e.substr(0,2)&&(l=!0,e=e.substr(2)),void 0===m[e]?(m[e]=new Image,
m[e].crossOrigin="Anonymous",m[e].loaded=!1,a++,function(b){m[b].addEventListener("load",function(){d++;m[b].loaded=!0;f[b]=m[b];m[b].width&&m[b].height||(m[b].src=F().src);d>=a&&c(f)});m[b].addEventListener("error",function(){d++;m[b].src=F().src;m[b].loaded=!0;f[b]=m[b];d>=a&&c(f)})}(e),l?m[e].src=e:(q?(m[e].isTexture=!0,q=h?g.settings.smallTextureFolder+e+".jpg":g.settings.textureFolder+e+".jpg"):q=g.settings.assetFolder+e+".png",r("Requesting "+q),m[e].src=q)):(a++,m[e].loaded?(d++,f[e]=m[e]):
function(b){m[b].addEventListener("load",function(){d++;f[b]=m[b];d>=a&&c(f)})}(e));a--;0<d&&d>=a&&c(f)})}function G(b){var c=b.canvas.width,d=b.canvas.height;b=b.getImageData(0,0,c,d).data;var a,f,e=999,g=999,h=0,l=0,k=!1;for(f=d-1;-1<f&&!k;f--)for(a=0;a<c;a++)if(0<b[4*f*c+4*a+3]){l=Math.max(l,f);k=!0;break}if(void 0===l)return null;a=c-1;a:for(;-1<a;a--)for(f=0;f<d;f++)if(0<b[4*f*c+4*a+3]){h=Math.max(h,a);break a}a=0;a:for(;a<h;a++)for(f=0;f<d;f++)if(0<b[4*f*c+4*a+3]){e=Math.min(a,e);break a}f=
0;a:for(;f<l;f++)for(a=0;a<c;a++)if(0<b[4*f*c+4*a+3]){g=Math.min(g,f);break a}return{x:e,y:g,maxX:h,maxY:l,w:h-e,h:l-g}}function Q(b,c,d){var a,f;a=g.races[d.language]?g.races[d.language][d.race]?g.races[d.language][d.race]:d.race:g.races.enUS[d.race]?g.races.enUS[d.race]:d.race;d=C();var e=d.getContext("2d");d.width=300;d.height=60;e.font="45px Belwe";e.lineCap="round";e.lineJoin="round";e.textBaseline="hanging";e.textAlign="left";a=a.split("");f=10;for(var q=0;q<a.length;q++)e.lineWidth=8,e.strokeStyle=
"black",e.fillStyle="black",e.fillText(a[q],f,10),e.strokeText(a[q],f,10),e.fillStyle="white",e.strokeStyle="white",e.lineWidth=1,e.fillText(a[q],f,10),f+=e.measureText(a[q]).width;a=G(e);b.drawImage(d,a.x,a.y,a.w,a.h,(394-a.w/2)*c,(1001-a.h/2)*c,a.w*c,a.h*c);t.push(d)}function x(b,c,d,a,f,e,g){var h=C(),l=h.getContext("2d");void 0===g&&(g="0");h.width=256;h.height=256;f=f.toString();f=f.split("");var k=10;l.font=e+"px Belwe";l.lineCap="round";l.lineJoin="round";l.textBaseline="hanging";l.textAlign=
"left";e="white";"-"===g&&(e="#f00");"+"===g&&(e="#0f0");for(g=0;g<f.length;g++)l.lineWidth=13,l.strokeStyle="black",l.fillStyle="black",l.fillText(f[g],k,10),l.strokeText(f[g],k,10),l.fillStyle=e,l.strokeStyle=e,l.lineWidth=2.5,l.fillText(f[g],k,10),k+=l.measureText(f[g]).width;f=G(l);b.drawImage(h,f.x,f.y,f.w,f.h,(c-f.w/2)*a,(d-f.h/2)*a,f.w*a,f.h*a);t.push(h)}function H(b,c,d,a,f,e){g.settings.debug&&(b.save(),b.strokeStyle="red",b.beginPath(),b.moveTo(e/2-a/2,f),b.lineTo(e/2+a/2,f),b.stroke(),
b.restore());e=e/2-a/2;0>e&&(e=0);0<a&&0<c.width&&b.drawImage(c,0,0,a>c.width?c.width:a,c.height,e,f,Math.min(a,c.width),c.height);a=5;f+=c.height;d.clearRect(0,0,c.width,c.height);return[a,f]}function M(b,c,d,a){var f="[x]"===d.text.substr(0,3),e=C(),q=e.getContext("2d"),h=C(),l=h.getContext("2d"),k=f?d.text.substr(3):d.text,m,p,n,v,u=0,w=0,A=0,B=0,D,x,z=0,y;for(y=k;null!==(m=R.exec(k));)y=y.replace(m[0],m[1]+m[2]+(1===parseInt(m[1],10)?m[3]:m[4]));k=y;m=k.replace(/[\$#_]/g,"").split(/( |\n)/g);
...
0,0,146,144,315*a,592*a,146*a,144*a),c.drawImage(n("title-weapon"),0,0,660,140,56*a,551*a,660*a,140*a),c.drawImage(n("swords"),0,0,312,306,32*a,906*a,187*a,183*a),c.drawImage(n("shield"),0,0,301,333,584*a,890*a,186*a,205*a)),k=8,"CORE"!==d.set&&function(){var b;"SPELL"===d.type&&(b=265);"MINION"===d.type&&(b=265);d.race&&"MINION"===d.type?c.drawImage(n(g.bgLogo),0,0,281,244,b*a,734*a,266.95*a,244*.95*a):"SPELL"===d.type?c.drawImage(n(g.bgLogo),0,0,281,244,b*a,740*a,253*a,220*a):c.drawImage(n(g.bgLogo),
0,0,281,244,b*a,734*a,281*a,244*a)}(),k=9,function(){var a=new Image;a.src=b.toDataURL();z[d._cacheKey]=a}());k=10;x(c,116,170,a,d.cost||0,170,d.costStyle);k=11;S(c,a,d);k=12;"MINION"===d.type&&(d.race&&Q(c,a,d),x(c,128,994,a,d.attack||0,150,d.attackStyle),x(c,668,994,a,d.health||0,150,d.healthStyle));k=13;"WEAPON"===d.type&&(x(c,128,994,a,d.attack||0,150,d.attackStyle),x(c,668,994,a,d.durability||0,150,d.durabilityStyle));k=14;d.silenced&&"MINION"===d.type?c.drawImage(n("silence-x"),0,0,410,397,
200*a,660*a,410*a,397*a):M(c,a,d);c.restore();clearTimeout(l);r("Rendertime: "+(Date.now()-m)+"ms");e();f.target.src=b.toDataURL()}function T(b){E.push([b,this]);A||J()}function J(){O&&(U(),window.requestAnimationFrame(J))}function U(){if(!(12<A)){var b,c,d;if(E.length){var a=E.shift();A++;b=a[0];c=b.width;d=a[1];var f=C(c,Math.round(1.4397905759*c),!0),e=f.getContext("2d"),g=c/764,a=["silence-x"];b._assetsLoaded===c?N(f,e,b,g,d,function(){A--;r("Card rendered: "+b.title);t.push(f)}):(r("Preparing assets for: "+
b.title),b.sunwell=b.sunwell||{},b.sunwell.cardBack=b.type.substr(0,1).toLowerCase()+b.playerClass.substr(0,1)+b.playerClass.substr(1).toLowerCase(),a.push(b.sunwell.cardBack),a.push("gem"),"MINION"===b.type&&(a.push("attack","health","title"),"LEGENDARY"===b.rarity&&a.push("dragon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),"SPELL"===b.type&&(a.push("attack","health","title-spell"),"FREE"===b.rarity||"COMMON"===
b.rarity&&"CORE"===b.set||(b.sunwell.rarity="spell-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),"WEAPON"===b.type&&(a.push("swords","shield","title-weapon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="weapon-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity))),-1==="BRM GVG LOE NAX TGT OG".split(" ").indexOf(b.set)?b.sunwell.bgLogo="bg-cl":b.sunwell.bgLogo="bg-"+b.set.toLowerCase(),"SPELL"===b.type&&(b.sunwell.bgLogo="spell-"+b.sunwell.bgLogo),a.push(b.sunwell.bgLogo),
b.race&&a.push("race"),"string"===typeof b.texture&&"CHEAT"!==b.set&&(.5>=g?a.push("h:"+b.texture):a.push("t:"+b.texture)),r("Assets prepared, now loading"),P(a).then(function(){r("Assets loaded for: "+b.title);b._assetsLoaded=c;N(f,e,b,g,d,function(){A--;r("Card rendered: "+b.title);t.push(f)})}))}}}var g,m={},O=!1,E=[],A=0,z={},t=[],R=/(\d+)(.+?)\|4\((.+?),(.+?)\)/g,V=["COMMON","RARE","EPIC","LEGENDARY"],B;window.sunwell=g=window.sunwell||{};g._buffers=t;g._renderQuery=E;g._activeRenders=A;g.settings=
