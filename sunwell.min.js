...
d.text.substr(0,3),e=C(),q=e.getContext("2d"),h=C(),k=h.getContext("2d"),l=g?d.text.substr(3):d.text,m,p,n,v,t=0,w=0,u=0,x=0,D,y,A=0,z;for(z=l;null!==(m=R.exec(l));)z=z.replace(m[0],m[1]+m[2]+(1===parseInt(m[1],10)?m[3]:m[4]));l=z;m=l.replace(/[\$#_]/g,"").split(/( |\n)/g);r("Rendering body: "+l);e.width=520;e.height=290;h.width=520;"SPELL"===d.type&&(e.width=460,e.height=290,h.width=460);"WEAPON"===d.type&&(e.width=470,e.height=250,h.width=470);l=f.settings.bodyFontSize;n=f.settings.bodyLineHeight;
D=d.text.replace(/<\/*.>/g,"").length;z=!1;80<=D&&(l=.9*f.settings.bodyFontSize,n=.9*f.settings.bodyLineHeight);100<=D&&(l=.8*f.settings.bodyFontSize,n=.8*f.settings.bodyLineHeight);h.height=n;75<=D&&"SPELL"===d.type&&(z=!0);a&&(z=!0);k.fillStyle="WEAPON"===d.type?"#fff":"#000";k.textBaseline="hanging";k.font=l+'px/1em "'+f.settings.bodyFont+'", sans-serif';for(D=0;D<m.length;D++){p=m[D];n=p.split("");v=k.measureText(p).width;r("Next word: "+p);!g&&(t+v>h.width||z&&t+v>.8*h.width)&&(r(t+v+" > "+h.width),
r("Calculated line break"),z=!1,A++,w=I(q,h,k,t,w,e.width),t=w[0],w=w[1],y=!0);for(p=0;p<n.length;p++)v=n[p],r(v+" "+v.charCodeAt(0)),10===v.charCodeAt(0)?y?y=!1:(A++,w=I(q,h,k,t,w,e.width),t=w[0],w=w[1],r("Manual line break")):(y=!1,"<"===v?("/"===n[p+1]?("b"===n[p+2]&&(u--,p+=3),"i"===n[p+2]&&(x--,p+=3)):("b"===n[p+1]&&(u++,p+=2),"i"===n[p+1]&&(x++,p+=2)),k.font=(0<u?"bold ":"")+(0<x?"italic":"")+" "+l+'px/1em "'+f.settings.bodyFont+'", sans-serif'):(k.fillText(v,t+f.settings.bodyFontOffset.x,f.settings.bodyFontOffset.y),
t+=k.measureText(v).width+.375));t+=3}A++;I(q,h,k,t,w,e.width);B.push(h);"SPELL"!==d.type||4!==A||z||a?(d=H(q),d.h=Math.ceil(d.h/h.height)*h.height,b.drawImage(e,d.x,d.y-2,d.w,d.h,(390-d.w/2)*c,(860-d.h/2)*c,d.w*c,(d.h+2)*c),B.push(e),f.settings.debug&&(b.save(),b.strokeStyle="green",b.beginPath(),b.rect((390-d.w/2)*c,(860-d.h/2)*c,d.w*c,(d.h+2)*c),b.stroke(),b.strokeStyle="red",b.beginPath(),b.rect((390-e.width/2)*c,(860-e.height/2)*c,e.width*c,(e.height+2)*c),b.stroke(),b.restore())):O(b,c,d,!0)}
...
d.type&&(M(c,150*a,135*a,476*a,468*a),c.clip(),c.fillStyle="grey",c.fillRect(0,0,765*a,1100*a),c.drawImage(h,0,0,h.width,h.height,150*a,135*a,476*a,476*a));c.restore();l=4;c.drawImage(n(f.cardBack),0,0,764,1100,0,0,b.width,b.height);l=5;d.costHealth?(c.drawImage(n("health"),0,0,167,218,24*a,62*a,167*a,218*a),c.save(),c.shadowBlur=50*a,c.shadowColor="#FF7275",c.shadowOffsetX=1E3,c.globalAlpha=.5,c.drawImage(n("health"),0,0,167,218,24*a-1E3,62*a,167*a,218*a),c.restore()):c.drawImage(n("gem"),0,0,182,
180,24*a,82*a,182*a,180*a);l=6;"MINION"===d.type&&(f.rarity&&c.drawImage(n(f.rarity),0,0,146,146,326*a,607*a,146*a,146*a),c.drawImage(n("title"),0,0,608,144,94*a,546*a,608*a,144*a),d.race&&c.drawImage(n("race"),0,0,529,106,125*a,937*a,529*a,106*a),c.drawImage(n("attack"),0,0,214,238,0,862*a,214*a,238*a),c.drawImage(n("health"),0,0,167,218,575*a,876*a,167*a,218*a),"LEGENDARY"===d.rarity&&c.drawImage(n("dragon"),0,0,569,417,196*a,0,569*a,417*a));l=7;"SPELL"===d.type&&(f.rarity&&c.drawImage(n(f.rarity),
0,0,149,149,311*a,607*a,150*a,150*a),c.drawImage(n("title-spell"),0,0,646,199,66*a,530*a,646*a,199*a));"WEAPON"===d.type&&(f.rarity&&c.drawImage(n(f.rarity),0,0,146,144,315*a,592*a,146*a,144*a),c.drawImage(n("title-weapon"),0,0,660,140,56*a,551*a,660*a,140*a),c.drawImage(n("swords"),0,0,312,306,32*a,906*a,187*a,183*a),c.drawImage(n("shield"),0,0,301,333,584*a,890*a,186*a,205*a));l=8;"CORE"!==d.set&&function(){var b;"SPELL"===d.type&&(b=265);"MINION"===d.type&&(b=265);d.race&&"MINION"===d.type?c.drawImage(n(f.bgLogo),
0,0,281,244,b*a,734*a,266.95*a,244*.95*a):"SPELL"===d.type?c.drawImage(n(f.bgLogo),0,0,281,244,b*a,740*a,253*a,220*a):c.drawImage(n(f.bgLogo),0,0,281,244,b*a,734*a,281*a,244*a)}();l=9;l=10;y(c,116,170,a,d.cost||0,170,d.costStyle);l=11;S(c,a,d);l=12;"MINION"===d.type&&(d.race&&Q(c,a,d),y(c,128,994,a,d.attack||0,150,d.attackStyle),y(c,668,994,a,d.health||0,150,d.healthStyle));l=13;"WEAPON"===d.type&&(y(c,128,994,a,d.attack||0,150,d.attackStyle),y(c,668,994,a,d.durability||0,150,d.durabilityStyle));
l=14;d.silenced&&"MINION"===d.type?c.drawImage(n("silence-x"),0,0,410,397,200*a,660*a,410*a,397*a):O(c,a,d);c.restore();clearTimeout(k);r("Rendertime: "+(Date.now()-m)+"ms");e();g&&g(b)}function K(b,c,d){A.push([b,c,d]);E||L()}function L(){P&&(U(),window.requestAnimationFrame(L))}function U(){if(!(12<E)){var b,c,d;if(A.length){var a=A.shift();E++;b=a[0];c=a[1];d=a[2];r("Preparing assets for: "+b.title);var g=C(),e=g.getContext("2d"),m=(c||512)/764,a=["silence-x"];g.width=c||512;g.height=Math.round(1.4397905759*
g.width);b.sunwell=b.sunwell||{};b.sunwell.cardBack=b.type.substr(0,1).toLowerCase()+b.playerClass.substr(0,1)+b.playerClass.substr(1).toLowerCase();a.push(b.sunwell.cardBack);a.push("gem");"MINION"===b.type&&(a.push("attack","health","title"),"LEGENDARY"===b.rarity&&a.push("dragon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity)));"SPELL"===b.type&&(a.push("attack","health","title-spell"),"FREE"===b.rarity||"COMMON"===
b.rarity&&"CORE"===b.set||(b.sunwell.rarity="spell-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity)));"WEAPON"===b.type&&(a.push("swords","shield","title-weapon"),"FREE"===b.rarity||"COMMON"===b.rarity&&"CORE"===b.set||(b.sunwell.rarity="weapon-rarity-"+b.rarity.toLowerCase(),a.push(b.sunwell.rarity)));-1===f.settings.sets.indexOf(b.set)?b.sunwell.bgLogo="bg-cl":b.sunwell.bgLogo="bg-"+b.set.toLowerCase();"SPELL"===b.type&&(b.sunwell.bgLogo="spell-"+b.sunwell.bgLogo);a.push(b.sunwell.bgLogo);
b.race&&a.push("race");"string"===typeof b.texture&&"CHEAT"!==b.set&&(.5>=m?a.push("h:"+b.texture):a.push("t:"+b.texture));r("Assets prepared, now loading");N(a).then(function(){r("Assets loaded for: "+b.title);T(g,e,b,m,d,function(){E--;r("Card rendered: "+b.title);B.push(g)})})}}}var f,m={},P=!1,A=[],E=0,u={},B=[],R=/(\d+)(.+?)\|4\((.+?),(.+?)\)/g,V=["COMMON","RARE","EPIC","LEGENDARY"],x;window.sunwell=f=window.sunwell||{};f._buffers=B;f._renderQuery=A;f._activeRenders=E;f.settings=f.settings||
{};f.settings.titleFont=f.settings.titleFont||"Belwe Bold";f.settings.bodyFont=f.settings.bodyFont||"ITC Franklin Condensed";f.settings.bodyFontSize=f.settings.bodyFontSize||60;f.settings.bodyFontOffset=f.settings.bodyFontOffset||{x:0,y:0};f.settings.bodyLineHeight=f.settings.bodyLineHeight||50;f.settings.assetFolder=f.settings.assetFolder||"/assets/";f.settings.textureFolder=f.settings.textureFolder||"/artwork/";f.settings.smallTextureFolder=f.settings.smallTextureFolder||null;f.settings.autoInit=
f.settings.autoInit||!0;f.settings.idAsTexture=f.settings.idAsTexture||!1;f.settings.misingImg=f.settings.misingImg||null;f.settings.sets="BRM GVG LOE NAX TGT OG".split(" ").concat(f.settings.customSets);f.settings.debug=f.settings.debug||!1;f.init=function(){"string"===typeof f.settings.misingImg&&N(["u:"+f.settings.misingImg]);P=!0;A.length&&L()};f.settings.autoInit||f.init();f.races={enUS:{MURLOC:"Murloc",MECHANICAL:"Mech",BEAST:"Beast",DEMON:"Demon",PIRATE:"Pirate",DRAGON:"Dragon",TOTEM:"Totem"},
deDE:{MURLOC:"Murloc",MECHANICAL:"Mech",BEAST:"Wildtier",DEMON:"D\u00e4mon",PIRATE:"Pirat",DRAGON:"Drache",TOTEM:"Totem"}};f.clearCache=function(){u={}};f.createCard=function(b,c,d){if(!b)throw Error("No card object given");d||(d=new Image);-1===V.indexOf(b.rarity)&&(b.rarity="FREE");void 0===b.title&&(b.title=b.name);void 0===b.gameId&&(b.gameId=b.id);f.settings.idAsTexture&&(b.texture=b.gameId);b.costStyle=b.costStyle||"0";b.healthStyle=b.healthStyle||"0";b.attackStyle=b.attackStyle||"0";b.durabilityStyle=
b.durabilityStyle||"0";b.silenced=b.silenced||!1;b.costHealth=b.costHealth||!1;b.width=c;var a=G(b);if(u[a]&&!f.settings.debug)d.src=u[a];else return r("Queried render: "+b.title),K(b,c,function(b){d.src=u[a]=b.toDataURL()}),{target:d,redraw:function(){a=G(b);delete u[a];K(b,c,function(b){d.src=u[a]=b.toDataURL()})},update:function(f){for(var e in f)b[e]=f[e];a=G(b);u[a]?d.src=u[a]:K(b,c,function(b){d.src=u[a]=b.toDataURL()})}}}})();